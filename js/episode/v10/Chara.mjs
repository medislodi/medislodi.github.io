...
export class Chara extends PIXI.Container {
    ...
    resetParam() {
        ...
        this.anime.x = 0;
        this.anime.y = 0;
        this.anime.scale.x = 1;
        this.anime.scale.y = 1;
        this.anime.pivot.x = Chara.CHARA_ANKER_X ;
        this.anime.pivot.y = Chara.CHARA_ANKER_Y;
        this.zIndex = 0;
    }
    ...
    serif(scenario) {
        this.isWait = false;
        // this.#animator.stop(this);
        console.log("@@ motion serif", scenario);
        this.isFront = true;
        return this.#animator.serif(this, scenario);
    }
    ...
    no_serif(scenario) {
        ...
        // this.#animator.stop(this);
        this.isFront = false;
        return this.#animator.back(this, scenario);

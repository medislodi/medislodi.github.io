...
export class Setting {
    ...
    set autoPlay(value){
        ...
        if(this.#autoPlay){
            ...
            document.querySelectorAll('.log-serif-title').forEach((element)=>{
                element.style.cursor = "initial";
            });
            this.player.ui.disableVoiceReplay();
            this.player.ui.disableRewind();
            this.player.canGotoSelect = false;
            this.player.canPrev = false;
        }else{
            ...
            this.player.ui.enableRewind();
            if( !(this.player.selectors.isSelecting() || this.player.textWindow.isSpeaking()) ) {
                this.player.canGotoSelect = this.player.hasSelect();
                this.player.canPrev = true;
            }
        }

...
export class Chara extends PIXI.Container {
    ...
    #showSprite(wear, face){
        ...
        return this.#animator.alphaTo(this.#faceSet[wear+"_"+face], 100, (this.player.isSkip && this.player.skipTarget !== this.player.scenario_index) ? 0 : 250 );
    }
    ...
    #hideSprite(wear, face){
        ...
        return this.#animator.alphaTo(this.#faceSet[wear+"_"+face], 0, (this.player.isSkip && this.player.skipTarget !== this.player.scenario_index) ? 0 : 250 ).then(()=>{this.#faceClean()});
    }

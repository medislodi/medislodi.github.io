...
export class TextWindow {
    ...
    set mode(value){
        ...
        switch (value) {
            case "down":
                document.getElementById("adv").classList.add("dp-down");
                this.#mode = "down";
                break;
            default:
                document.getElementById("adv").classList.remove("dp-down");
                this.mode = "normal";
        }
    }
    ...
    addReplayVoiceBtn(clone, voice_ids, after = false){
        console.log('@@+@@ voice for replay', voice_ids, after);
